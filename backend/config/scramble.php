...
return [
    ...
    'info' => [
        ...
        'description' => <<<TEXT
    REST API Backend LANTERA

    LANTERA merupakan sistem informasi pengelolaan prestasi mahasiswa.

    Dokumentasi ini digunakan oleh Frontend Developer
    untuk mengintegrasikan seluruh layanan backend.
